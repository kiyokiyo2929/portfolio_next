          ...
          <div className="work_flex">
             <div id="work_left">
                <ul className="tab_list">
                    ...
                    <Link href="/works/next"><li className="highlight_tag"><a>Next.js</a></li></Link>
                ...
                <p className="result_number">Works with Next.js / <span className="result_number_bold">{number} </span> works</p>
                <div>
